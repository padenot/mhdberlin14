subsub.prototype = extend(Instrument);
...
function subsub(ctx) {
  ...
  this.register_param("sustain", 0.6, 0.0, 1.0, 0.0);
...
subsub.prototype.name = function() {
  return "subsub";
}

subsub.prototype.trigger = function(note, velocity, time) {
  ...
  this.gain.gain.setTargetAtTime(0.0, ac.currentTime + this.p("attack"), this.p("decay"));
}

subsub.prototype.connect = function(node) {
